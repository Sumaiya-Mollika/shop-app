...
class _AuthCardState extends State<AuthCard>
  ...
  void initState() {
    ...
    _slideAnimation = Tween<Offset>(
        ...
        .animate(CurvedAnimation(parent: _controler!, curve: Curves.fastOutSlowIn));
    _opacityAnimation=Tween(begin: 0.0,end: 1.0).animate(CurvedAnimation(parent: _controler!,curve: Curves.easeIn));
